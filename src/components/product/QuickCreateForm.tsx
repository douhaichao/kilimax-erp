...
const QuickCreateForm = ({ onClose, onSave, categories, systemUOMs = [] }: QuickCreateFormProps) => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl text-blue-800">Create Product - Multi UOM</CardTitle>
        </CardHeader>
        <CardContent>
          {/* Progress Steps */}
          <div className="flex items-center justify-center space-x-4 py-6 border-b border-blue-200 overflow-x-auto mb-6">
            {steps.map((step) => (
